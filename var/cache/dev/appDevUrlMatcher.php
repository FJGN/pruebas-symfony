...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/hello') && preg_match('#^/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'hello')), array (  '_controller' => 'AppBundle\\Controller\\HelloController::helloAction',));
        }
        ...
        // app_lucky_nombre
        if (0 === strpos($pathinfo, '/nombre') && preg_match('#^/nombre/(?P<nombre>[^/]++)/(?P<color>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'app_lucky_nombre')), array (  '_controller' => 'AppBundle\\Controller\\LuckyController::nombreAction',));
        }
